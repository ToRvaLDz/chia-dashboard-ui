...
@Component({
  selector: 'app-farm-summary-goji',
  templateUrl: './farm-summary-goji.component.html',
  styleUrls: ['./farm-summary-goji.component.scss']
})
export class FarmSummaryGojiComponent implements OnInit {

...
@Component({
  selector: 'app-wallet-summary-goji',
  templateUrl: './wallet-summary-goji.component.html',
  styleUrls: ['./wallet-summary-goji.component.scss']
})
export class WalletSummaryGojiComponent implements OnInit {
  @Input() wallets: any;
